 ...
 */
function generateAccount(username, password) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, (0, auth_utils_1.saveUser)(user)];
                case 2:
                    // Save user to temporary file
                    _a.sent();
                    console.log("Account created successfully for user: ".concat(username));
                    console.log("Creation timestamp: ".concat(user.createdAt));
                    return [3 /*break*/, 4];
                case 3:
                    error_1 = _a.sent();
                    console.error('Error generating account:', error_1);
                    process.exit(1);
                    return [3 /*break*/, 4];
