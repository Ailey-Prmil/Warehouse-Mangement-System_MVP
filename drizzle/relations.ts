...
export const inboundShipmentDetailRelations = relations(
  inboundShipmentDetail,
  ({ one }) => ({
    inboundShipment: one(inboundShipment, {
      fields: [inboundShipmentDetail.shipId],
      references: [inboundShipment.shipId],
    }),
    product: one(product, {
...
export const inboundShipmentRelations = relations(
  inboundShipment,
  ({ many }) => ({
    inboundShipmentDetails: many(inboundShipmentDetail),
...
export const orderTransactionRelations = relations(
  orderTransaction,
  ({ one }) => ({
    customerOrder: one(customerOrder, {
...
export const purchaseOrderDetailRelations = relations(
  purchaseOrderDetail,
  ({ one }) => ({
